                ...
                children: [
                    ...
                    children: [
                      CircleAvatar(
                        ...
                        child: _experience!.organizer.profilePicture == null
                            ? Text(_experience!.organizer.username[0])
                            : null,
                      ),
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            Text(
                              'Hosted by ${_experience!.organizer.username}',
                  ...
                  if (_experience!.schedule.isNotEmpty)
                    _buildInfoSection(
                      'Schedule',
                      Column(
                        children: _experience!.schedule.map((item) {
                          return ListTile(
                  ...
                  if (_experience!.pricingTiers.isNotEmpty)
                    _buildInfoSection(
                      'Pricing',
                      Column(
                        children: _experience!.pricingTiers.map((tier) {
                          return Card(
                            child: ListTile(
      ...
      bottomNavigationBar: _experience == null
        ...
        child: Row(
          children: [
            ...
            // Join button
            ElevatedButton(
              onPressed: _experience!.isFull || _isJoining
                  ? null
                  : _handleJoinEvent,
