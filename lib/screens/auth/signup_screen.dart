            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _SectionLabel(
                      label: 'Your Details', color: context.textColor),
                  ...
                  const SizedBox(height: 24),
                  _SectionLabel(
                      label: 'Set Password', color: context.textColor),
                  const SizedBox(height: 10),
                  Container(
                      decoration: _cardDecoration(context),
                      child: Column(children: [
...
class _GenderCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final primaryGlass = context.isDark
      ...
      child: GestureDetector(
        ...
        child: AnimatedContainer(
          ...
          child: Column(
            children: [
              Icon(icon,
                  color: isSelected ? primaryColor : context.mutedColor,
                  size: 24),
  ...
  Widget build(BuildContext context) {
    return TextFormField(
        ...
        decoration: InputDecoration(
          hintText: hint,
          hintStyle:
              AppTypography.bodyMedium.copyWith(color: context.mutedColor),
