      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildFeatureRow(icon: PhosphorIcons.planet, title: 'Emotion Wheel', subtitle: 'Visualize your current feelings'),
            const SizedBox(height: 12),
            _buildFeatureRow(icon: PhosphorIcons.person, title: 'Body Scan', subtitle: 'Connect with physical sensations'),
            const SizedBox(height: 12),
            _buildFeatureRow(icon: PhosphorIcons.chats, title: 'Needs Assessment', subtitle: 'Articulate what you need'),
            const SizedBox(height: 16),
          ],
        ),
      ),
